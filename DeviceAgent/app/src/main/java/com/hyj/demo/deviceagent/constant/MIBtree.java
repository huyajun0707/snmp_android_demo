...
public class MIBtree {
    ...
    //警告
    //空间不足
    public static final OID HARD_DISK_AVAILABLE_SPACE_OVER_OID = new OID(new int[]{1, 3, 6, 1, 4, 1, 12619, 2, 1});
    //电池温度过高
    public static final OID BATTERY_HEALTH_OVERHEAT_OID = new OID(new int[]{1, 3, 6, 1, 4, 1, 12619, 2, 2});
    //影片播放错误2
    public static final OID MOVIE_PLAY_ERROR_OID = new OID(new int[]{1, 3, 6, 1, 4, 1, 12619, 2, 3});
}
